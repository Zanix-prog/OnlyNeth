...
const JoinSection = () => {
  ...
  const GOOGLE_FORM_URL =
    "https://docs.google.com/forms/d/e/1FAIpQLSfM9ip1vt6-WpbbJ3Mtzcxm4_2Uq5R3PXV-a5Tdoc-LrCrYjA/formResponse";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your application has been received by OnlyNeth Higher Ups..",
        duration: 5000,
      });
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Think you have what it takes? Apply for OnlyNeth and prove your worth for the team.
          </p>

          <div className="glass-card px-6 py-4 rounded-xl border-l-4 border-primary inline-block">
            <p className="text-sm text-muted-foreground">
              ⚠️ Only Good players are accepted — mediocrity isn't tolerated.
            </p>
          </div>
        </div>
        ...
        <div className="glass-card p-12 rounded-2xl holographic-border relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="relative space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-sm font-bold font-[Orbitron] uppercase tracking-wider flex items-center gap-2">
                <span className="text-secondary">▸</span> Why OnlyNeth?
              </label>
              <Textarea
                required
                placeholder="Tell us why you fit As A Guild Member In OnlyNeth."
            ...
            <p className="text-xs text-center text-muted-foreground">
              🔒 All transmissions are encrypted and sent to OnlyNeth Council
            </p>
          </form>
